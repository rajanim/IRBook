 ...
 */
public class GenerateIndexWithPositions {

    // constants
    private static final Logger LOGGER = Logger.getLogger(GenerateIndexWithPositions.class.getName());
    ...
    * */
    public static void main(String[] args) {
        try {
            ...
            GenerateIndexWithPositions generateIndex = new GenerateIndexWithPositions();
